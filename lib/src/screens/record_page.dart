...
class RecordPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final recordPageProvider = Provider.of<RecordPageProvider>(context);
    // if (recordPageProvider.rows.length < 1) {
      // recordPageProvider.addRow(advancedModeProvider.showAdvanced);
    // }
              ...
              children: [
                ...
                Switch(
                  ...
                  onChanged: (value) {
                    ...
                    recordPageProvider.convertRows(value);
                  },
